...
namespace Server_project_432
{
    public partial class Form2 : Form
    {
        ...
        {
            string file_path = @"C:\Users\emreeren\Desktop\Intro432Proje\Server_project_432\bin\Debug\net5.0-windows\files";
        ...
        {
            string filePath = @"C:\Users\emreeren\Desktop\Intro432Proje\Server_project_432\bin\Debug\net5.0-windows\files";
        ...
        private void server2_connect_button_Click(object sender, EventArgs e)
        {
            ...
            if (Int32.TryParse(server2_port_textBox.Text, out port)) 
            {
                try
                {
        ...
        private void fileReplication()
        {
            while (listening)
            {
                ...
                while (not_replicated_files.Count > 0 && not_replicated_file_names.Count > 0 && master_connected && server2_connected && server2_master_connected)
                {
...
//if (master_connected && server2_connected && server2_master_connected && master_keys_recieved && server2_keys_recieved)
//{
//    //try
//    //{
